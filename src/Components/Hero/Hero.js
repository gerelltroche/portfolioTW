...
const Hero = () => (
    ...
    id={'Home'}>
        ...
        <div className={'z-50 flex flex-col justify-center items-center text-3xl'}>
            ...
            <a href={'#Portfolio'}
                className="transition bg-blue-500 hover:bg-blue-400 text-gray-50 font-bold py-2 px-4
                border-b-4 border-blue-700 hover:border-blue-500 hover:text-white rounded"
            >
